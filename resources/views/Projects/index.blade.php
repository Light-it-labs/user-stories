  ...
  <div class="overflow-x-auto mt-6">
    <div class="flex items-center justify-between flex-wrap sm:flex-nowrap mb-4">
      ...
      <div class="ml-4 mt-2 flex-shrink-0">
        <a href="/projects/create" class="relative inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          New Project
        </a>
      </div>
    </div>
      ...
      <tbody class="text-sm font-normal text-gray-700">
        ...
        <tr class="hover:bg-gray-100 border-b border-gray-200 py-10">
          ...
          <td class="px-6 py-4 text-right text-sm font-medium flex flex-col flex-end">
            ...
            <a href="/projects/{{$project->id}}/delete" class="text-indigo-600 hover:text-indigo-900">Delete</a>
          </td>
        </tr>
